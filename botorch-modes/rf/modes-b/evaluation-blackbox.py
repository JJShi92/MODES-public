...
def main(argv):
    ...
    result_name = '/home/junjie/modes/botorch/' + folder_name + '/modes-b/results-' + method_name + '-dataset-' + str(datasets_number) + '.csv'
    ...
    for i in range (1, 11):
        ...
        csv_predicted_name_local = local_path + folder_name + '/modes-b/predicted_results_' + str(
            method_name) + '_trial_' + str(i) + '_' + str(current_time) + '.csv'

        csv_observed_name = remote_path + folder_name + '/modes-b/observed_results_' + str(
            method_name) + '_trial_' + str(i) + '_' + str(current_time) + '.csv'
        csv_observed_name_local = local_path + folder_name + '/modes-b/observed_results_' + str(method_name) + '_trial_' + str(i) + '_' + str(current_time) + '.csv'
        ...
        with open(result_name, 'a+') as csvFile:
            writer = csv.writer(csvFile)
            writer.writerow([str(float(temp_results_1/sum(predicted_weights))), str(float(temp_results_2/sum(observed_weights)))])
        csvFile.close()
